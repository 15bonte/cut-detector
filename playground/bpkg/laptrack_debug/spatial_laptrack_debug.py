...
class SpatialLaptrackDebug(LapTrack):
    ...
    #     False,
    #     description="Show coordinates at the beginning of predict_links"
    # )

    # show_dist_metric_mat: Literal["y", "n", "w"] = Field(
    #     "n",
    #     description="Show the distance metric matrix (y) and wait (w), or not (n)"
    # )

    # show_spatial_dist_metric_mat: Literal["y", "n", "w"] = Field(
    #     "n",
    #     description="Show the spatial distance metric matrix (y) and wait (w), or not (n)"
    # )

    # show_dist_metric_cost_mat: Literal["y", "n", "w"] = Field(
    #     "n",
    #     description="Show the cost matrix of the dist metric (y) and wait (w), or not (n)"
    # )

    # show_dist_metric_lap_opt: Literal["y", "n", "w"] = Field(
    #     "n",
    #     description="Show the lap optimisation result of the cost matrix (y) and wait (w), or not (n)"
    # )

    # show_post_lap_metric_resolution: bool = Field(
    #     False,
    #     description="Show the edge creation from the LAP results"
    # )
