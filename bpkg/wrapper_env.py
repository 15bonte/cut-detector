...
from cut_detector.utils.gen_track import TRACKING_METHOD
...
class WrapperEnv:
    ...
    main_spot_detection_method: MidBodyDetectionFactory.SPOT_DETECTION_METHOD = detection.cur_log
    
    main_tracking_method: TRACKING_METHOD = tracking.cur_spatial_laptrack
    main_slt_tracking_method: TRACKING_METHOD = tracking.cur_spatial_laptrack
